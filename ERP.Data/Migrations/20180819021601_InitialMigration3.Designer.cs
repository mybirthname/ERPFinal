...
namespace ERP.Data.Migrations
{
    ...
    [Migration("20180819021601_InitialMigration3")]
            ...
            modelBuilder.Entity("ERP.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("065548f8-a5a6-4e2a-a30f-000b8d109ed2"), City = "Sofia", Country = "Bulgaria", CreateBy = "Automatic Seed Function", CreateDate = new DateTime(2018, 8, 19, 5, 16, 1, 108, DateTimeKind.Local), Deleted = 0, Description = "Organization of the company which provides ", Email = "ContactCompanyEmail@CompanyDomain.com", Phone = "+359 888 123 456", ProviderOrganizationID = new Guid("00000000-0000-0000-0000-000000000000"), Remark = "Values are filled automatically", Title = "Provider Organization", UpdateBy = "Automatic Seed Function", UpdateDate = new DateTime(2018, 8, 19, 5, 16, 1, 108, DateTimeKind.Local), ZipCode = "1000" }
                    );
                });
            ...
            modelBuilder.Entity("ERP.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "065548f8-a5a6-4e2a-a30f-000b8d109ed2", ConcurrencyStamp = "7d35c1f7-67ae-41a2-9a8e-5991a363b485", Name = "SuperAdmin", NormalizedName = "SUPERADMIN" }
                    );
                });
            ...
            modelBuilder.Entity("ERP.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "49dc92d3-0025-42eb-8bc0-b3c3acde0f39", AccessFailedCount = 0, ConcurrencyStamp = "28164a03-8480-4cc0-bdcf-27a8ca4bd1fd", CreateBy = "Automatic Seed Function", CreateDate = new DateTime(2018, 8, 19, 5, 16, 1, 94, DateTimeKind.Local), Email = "martin.stanchev87@gmail.com", EmailConfirmed = true, FirstName = "Martin", LastName = "Stanchev", LockoutEnabled = false, NormalizedEmail = "MARTIN.STANCHEV87@GMAIL.COM", NormalizedUserName = "MARTIN.STANCHEV87@GMAIL.COM", OrganizationID = new Guid("065548f8-a5a6-4e2a-a30f-000b8d109ed2"), PasswordHash = "AQAAAAEAACcQAAAAEM5VtQPh69WHjtJlu6WLw0Evx5rB/47K1DrIBUW4FhtT6oihduvjdipsp6S2Kh/EBw==", PhoneNumberConfirmed = false, SecurityStamp = "fa66e521-295f-43be-87bb-65d197affebd", TwoFactorEnabled = false, UpdateBy = "Automatic Seed Function", UpdateDate = new DateTime(2018, 8, 19, 5, 16, 1, 95, DateTimeKind.Local), UserName = "martin.stanchev87@gmail.com" }
                    );
                });
