...
namespace ERP.Data.Migrations
{
    ...
    [Migration("20180819021646_InitialMigration4")]
            ...
            modelBuilder.Entity("ERP.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("065548f8-a5a6-4e2a-a30f-000b8d109ed2"), City = "Sofia", Country = "Bulgaria", CreateBy = "Automatic Seed Function", CreateDate = new DateTime(2018, 8, 19, 5, 16, 46, 701, DateTimeKind.Local), Deleted = 0, Description = "Organization of the company which provides ", Email = "ContactCompanyEmail@CompanyDomain.com", Phone = "+359 888 123 456", ProviderOrganizationID = new Guid("00000000-0000-0000-0000-000000000000"), Remark = "Values are filled automatically", Title = "Provider Organization", UpdateBy = "Automatic Seed Function", UpdateDate = new DateTime(2018, 8, 19, 5, 16, 46, 701, DateTimeKind.Local), ZipCode = "1000" }
                    );
                });
            ...
            modelBuilder.Entity("ERP.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "065548f8-a5a6-4e2a-a30f-000b8d109ed2", ConcurrencyStamp = "9e2aed98-761d-43ff-8456-3a5aa58cb9b2", Name = "SuperAdmin", NormalizedName = "SUPERADMIN" }
                    );
                });
            ...
            modelBuilder.Entity("ERP.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "49dc92d3-0025-42eb-8bc0-b3c3acde0f39", AccessFailedCount = 0, ConcurrencyStamp = "69bf0484-2995-4ecd-ba6d-314f19c7e0e8", CreateBy = "Automatic Seed Function", CreateDate = new DateTime(2018, 8, 19, 5, 16, 46, 686, DateTimeKind.Local), Email = "martin.stanchev87@gmail.com", EmailConfirmed = true, FirstName = "Martin", LastName = "Stanchev", LockoutEnabled = false, NormalizedEmail = "MARTIN.STANCHEV87@GMAIL.COM", NormalizedUserName = "MARTIN.STANCHEV87@GMAIL.COM", OrganizationID = new Guid("065548f8-a5a6-4e2a-a30f-000b8d109ed2"), PasswordHash = "AQAAAAEAACcQAAAAEB88M+z7rdbgsic0bNhDLYlmGAlC5B8iI/uYDD14fRMarOxFRgLwI1i7Pp+bt45XyA==", PhoneNumberConfirmed = false, SecurityStamp = "92afb652-0a63-4dfb-b5a0-511d456feda6", TwoFactorEnabled = false, UpdateBy = "Automatic Seed Function", UpdateDate = new DateTime(2018, 8, 19, 5, 16, 46, 688, DateTimeKind.Local), UserName = "martin.stanchev87@gmail.com" }
                    );
                });
